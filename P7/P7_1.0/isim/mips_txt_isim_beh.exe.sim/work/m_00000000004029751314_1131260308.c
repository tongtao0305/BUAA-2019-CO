...
#endif
static const char *ng0 = "D:/tongt/Desktop/P7/P7_1.0/tb.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {5, 0};
static unsigned int ng4[] = {20504U, 0U};
...
{
	static char *pe[] = {(void *)Initial_48_0,(void *)Always_61_1,(void *)Always_63_2};
